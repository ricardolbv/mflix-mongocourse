...
namespace Migrator
{
    ...
    class Program
    {
        ...
        static string mongoConnectionString = "mongodb+srv://m001-student:m001-mongodb-basics@cluster0.eo1s5.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
        ...
        static async Task Main(string[] args)
        {
            ...
            if (datePipelineResults.Count > 0)
            {
                ...
                bulkWriteDatesResult = await _moviesCollection.BulkWriteAsync(
                    datePipelineResults.Select(updateDate => new ReplaceOneModel<Movie>(
                        new FilterDefinitionBuilder<Movie>().Where(m => m.Id == updateDate.Id),
                        updateDate)));
